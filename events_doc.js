...
@param {Object} handshake_data Application-specific data which the peer sent along with the handshake message. If you specified a `parse_handshake_data` function in the `BPMux` [constructor](#BPMux_carrieroptions) then `handshake_data` will be the return value from calling that function.
